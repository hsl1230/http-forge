  ...
  var RequestTesterApp = class {
    ...
    updateDocTab(doc) {
      ...
      if (doc) {
        ...
        if (docContent) {
          docContent.innerHTML = '<div class="doc-toolbar"><button class="doc-open-file-btn" id="doc-open-file-btn" title="Open documentation in editor"><span class="codicon codicon-go-to-file"></span> Open File</button></div>' + this.renderMarkdown(doc);
