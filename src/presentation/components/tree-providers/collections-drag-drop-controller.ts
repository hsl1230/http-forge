import { CollectionService } from '@http-forge/core';
import * as vscode from 'vscode';
import type { CollectionTreeItem } from './collections-tree-provider';

/**
 * MIME type for drag and drop
 */
export const COLLECTION_ITEM_MIME_TYPE = 'application/vnd.code.tree.httpForge.collections';
 ...
 */
export class CollectionsDragAndDropController implements vscode.TreeDragAndDropController<CollectionTreeItem> {
